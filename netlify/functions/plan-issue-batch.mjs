...
- ARTICLE LENGTH CLASS: choose SHORT for a tight 300–450 word permanent search asset that can answer one narrow question without padding; choose FULL for a substantive 550–850 word article. SHORT is not a lesser article and uses the same research/SEO/Letterman pipeline.
- CORE SUBJECT: state the reusable underlying subject/question without the local place name where possible. The finished article will still require local proof; this supports future local editions without copy-and-replace localisation.

STRICT JSON ONLY:
{"issue_summary":"","articles":[{"mode":"REUSE|LOCALISE|REFRESH|CREATE NEW","existing_article_id":"","title":"","question":"","problem":"","hook":"","reader":"","value":"","article_length":"FULL|SHORT","core_subject":"","local_proof":"","evidence":"","life_lane":"Home & Property|Home Improvement & Garden|Money & Household Costs|Family & Children|Health & Wellbeing|Food & Dining|Pets & Animals|Motoring & Transport|Travel, Days Out & Experiences|Leisure, Culture & Entertainment|Community & Local Change|Work, Business & Opportunity|Open","lane":"Authority|Feature Partner|Activation|Community|Editorial|Open","partner_path":"","cta_type":"None|Reply|Comment|Save|Nominate|Button|Ask Expert|Booking|Directory","cta_text":"","stance":"PRACTICAL|NEUTRAL|CHALLENGE|CONTRARIAN|DEBATE|UNFILTERED","why_now":"","countercase":"","source_signal":""}]}`;
...
JSON ONLY:
{"issue_summary":"","articles":[{"mode":"REUSE|LOCALISE|REFRESH|CREATE NEW","existing_article_id":"","title":"","question":"","problem":"","hook":"","reader":"","value":"","article_length":"FULL|SHORT","core_subject":"","local_proof":"","evidence":"","life_lane":"Open","lane":"Editorial","partner_path":"Open","cta_type":"None","cta_text":"","stance":"PRACTICAL","why_now":"","countercase":"","source_signal":""}]}`;
