...
- READER DELIGHT FAILURE: supporting components are not filler. Warn when several blocks fail to entertain, surprise, help, tempt, amuse or reward the reader, or when they repeatedly restate the issue theme without adding a new fact, laugh, useful action, vivid local example, discovery or genuinely interesting choice;
- VALUE-BEFORE-ASK FAILURE: warn when the issue repeatedly asks readers to comment, vote, nominate, reply or share before giving them something worth their time. Reader allegiance is earned; engagement prompts should follow value rather than substitute for it;
- SHAREABILITY / HABIT FAILURE: warn when support feels interchangeable, dutiful or brochure-like instead of giving readers lines, discoveries, jokes, opinions, mini-wins or local details they might naturally mention to someone else;
