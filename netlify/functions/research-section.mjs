...
const RELEASE_VERSION='3.9.1-RESEARCH-SYNC';
...
function wrongGeographySource(x,fields){
  ...
  if(/\bpeterborough\b/.test(article)&&/peterborough,? ontario|ontario,? canada|\bcanada\b|kawartha|otonabee|trent university|peterborough\.ca|tripadvisor\.ca|peterborough,? new hampshire|\bnew hampshire\b|peterboroughnh\.gov|\bpeterborough,? nh\b|\bpeterborough nh\b/.test(blob))return true;
